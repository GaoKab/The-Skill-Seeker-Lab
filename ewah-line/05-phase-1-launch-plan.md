...
1. **Pre-launch (during sampling):** document the journey — "I went back to training and refused to buy someone else's clothes, so I made my own." Founder-fit content (you wearing protos at the gym) is the marketing engine and costs nothing
2. **PP-sample photoshoot:** shoot the campaign on the pre-production samples (the boards' aesthetic — warm stone backdrop, gold branding visible) so launch content is ready before stock lands
3. **Drop model:** limited first drop, waitlist, sell through, reorder fast. Scarcity is honest at 1,000 units and de-risks inventory
4. **Channel:** own webshop first (Shopify); marketplaces/wholesale only after fit reviews accumulate

## Success criteria for Phase 1
- Sell-through ≥ 70% in 90 days on at least 2 of 4 styles
- Return rate < 15% with fit-related returns < half of that (this validates the curve grading)
...
- Warrior Flow rust capsule as the first "statement drop" once the audience exists
