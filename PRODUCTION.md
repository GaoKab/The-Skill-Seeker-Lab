# PULA / Rain Objects — Production & Product Playbook

Focus: get physical samples in hand fast, lock a manufacturer, and expand the product line for the Boipuso 60 crowd in DC. Deadline discipline: **samples this week (by ~Sept 12), production booked Sept 17, goods in hand by Sept 27.**
...
Ranked by speed-to-produce and margin, all doable inside the window:

1. **Stickers** — die-cut PULA raindrop / "A ENE!!!" / BW60. Sticker Mule or StickerApp, ~4-day turnaround, ~$0.40–0.80 each in 100s, sell 3 for $5. Throw one free into every merch order (marketing that people stick on laptops and water bottles).
2. **Button pins** — "60", the raindrop, "PULA." A local button maker (or a $60 press and blanks) gets cost to ~$0.30, sell $3–5. Impulse buy at any event table.
3. **Botswana flag bandanas** — flag-blue with the black/white band, rain streaks along the edge. Custom printed bandanas run fast domestically (4over, Printful, bandanna printers); cost $3–6, sell $12–15. **Everyone wants something flag-colored to wear/wave at a celebration** — this may outsell tees per dollar invested.
4. **Wholesale Botswana flags, resold** — small hand flags and car flags from US flag wholesalers, ~$1.50–3 each, sell $8–10. Zero design work; pure margin at the event.
5. **Beaded bracelets in flag colors** — blue/white/black beads, handmade in evenings, cost under $1, sell $8–10. Huge at African celebrations, and "handmade by us" is part of the appeal.
6. **Skip for this window:** enamel pins, knit scarves, embroidered patches from overseas — 3–4 week lead times from China make them a post-Boipuso product.

## 3. Digital products & tools aimed at the DC crowd

Two buckets — things that **earn** and things that **sell the merch**:

### Earners
- **Boipuso 60 party kit (instant download):** printable banners, flag bunting, cupcake toppers, "60 years" photo-booth props, all in the PULA visual language. Sell $8–15 on the drop page/Etsy. Zero marginal cost, and every diaspora household hosting a watch party anywhere in the US is a customer — not just DC.
- **Digital invitation/flyer templates** for people hosting their own Independence events (Canva-template links are the easy delivery). $5–10 each.
- **Portrait/photo offer at the celebration:** if you two have any photo skill, pre-sell "Boipuso 60 portrait" slots ($15–25) — families dress up for this event and want good photos. Book slots before you go; shoot in DC.

### Merch-sellers (free, but they move product)
- **A "Boipuso 60 DC" companion page:** countdown, event-day info, a Setswana greetings mini-phrasebook, the anthem, a celebration playlist — with the drop woven through it. Shared into DMV WhatsApp groups, it markets the merch without being an ad. (Claude can build this fast.)
- **QR cards** on the event table linking to the drop page for people who see the gear in person.
- **WhatsApp sticker pack / IG story templates** in the PULA style — free, spreads the brand through the exact audience.
